...
class Hanoi(Frame):
    ...
    def createDisk(self,x,d,t):
        if t == 1:
            self.towers.create_rectangle(self.width/6-(5*x), self.height-(2*(d-1) + 10*d),(self.width/6)+(5*x), self.height-(2*(d-1) + 10*(d-1)),fill="yellow")
        if t == 2:
            self.towers.create_rectangle((self.width/2)-(5*x), self.height-(2*(d-1) + 10*d),(self.width/2)+(5*x), self.height-(2*(d-1) + 10*(d-1)),fill="yellow")
        if t == 3:
            self.towers.create_rectangle((5*self.width/6)-(5*x), self.height-(2*(d-1) + 10*d),(5*self.width/6)+(5*x), self.height-(2*(d-1) + 10*(d-1)),fill="yellow")
